      ...
      $this->promptManager->setConfig([
        ...
        [
          ...
          'prompt' => "Rules & Context for processing Word document content:\n\n"
            ...
            . "4. Do NOT repeat titles in the generated response. If a title has already been used as the 'title' field, do not include it again in the body content.\n"
            . "5. ONLY include fields that have actual data. Do NOT include empty entity reference fields (like field_featured_image, field_tags, etc) unless they have valid data.\n\n"
            . "Date and Time Rules:\n"
